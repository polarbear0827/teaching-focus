...
OUT="${TEACHINGFOCUS_PKG_PATH:-../TeachingFocus-v1.0.0-beta.6-arm64.pkg}"
...
pkgbuild --root "$STAGE/root" --component-plist "$STAGE/components.plist" --identifier tw.teachingfocus.mac.pkg --version 1.0.0.6 --install-location / --ownership recommended "$OUT"
